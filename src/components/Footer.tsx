...
export default function Footer() {
  ...
  return (
    <footer
      className={`footer-shell px-[20px] sm:px-[80px] pb-[40px] w-full border-t transition-all duration-700 relative mt-[80px] sm:mt-[100px] shadow-[0_-20px_50px_rgba(244,63,94,0.05)] ${isLight ? 'border-slate-200' : 'border-white/5'}`}
      style={{
    ...
    >
      <div className="w-full relative">
        ...
        <div className="w-full max-w-[1200px] mx-auto rounded-3xl overflow-hidden relative shadow-2xl -mt-[50px] mb-[60px] z-20 min-h-[160px] flex items-center bg-transparent group">
          <div
          ...
          />
          <div className="px-[30px] md:px-[50px] py-[30px] md:py-[40px] flex flex-col md:flex-row items-center justify-between relative z-10 w-full gap-4">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-[24px] md:mb-0 text-center md:text-left tracking-tight">
        ...
        <div className="border-t border-white/10 pt-[60px] pb-[40px] flex flex-col items-center w-full">
          {/* Social Links */}
